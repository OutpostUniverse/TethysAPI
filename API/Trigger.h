...
struct OnTriggerArgs {
  ...
  PlayerBitmask triggeredBy;      ///< [1.4.2]  Bitmask of players currently activating this trigger.
  PlayerBitmask prevTriggeredBy;  ///< [1.4.2]  Bitmask of players that were previously activating this trigger.
};
...
// =====================================================================================================================
/// Creates a trigger used for "have enough Evacuation Transports for your population" victory conditions.
inline Trigger CreateEvacTransportTrigger(
